...
public class BookingCustomModal {
	...
	public String toString() {
		return "BookingCustomModal [bookingDate=" + bookingDate + ", bookingFromDate=" + bookingFromDate
				...
				+ ", guesture=" + guesture + ", guestName=" + guestName + ", companyName=" + companyName + ", phoneNo="
				+ phoneNo + ", city=" + city + ", emailId=" + emailId + ", bookingStatus=" + bookingStatus
				+ ", roomType=" + roomType + ", noOfRooms=" + noOfRooms + ", pax=" + pax + ", bookingId=" + bookingId
